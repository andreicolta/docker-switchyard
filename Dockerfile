...
RUN curl http://files.amakitu.com/switchyard-1.1.0.Final-EAP6.1.GA.zip -o /tmp/switchyard-1.1.0.Final-EAP6.1.GA.zip
RUN unzip -o /tmp/switchyard-1.1.0.Final-EAP6.1.GA.zip -d $EAP_HOME
RUN rm -rf /opt/jboss/jboss-eap-6.1/modules/system/layers/soa/org/jbpm
